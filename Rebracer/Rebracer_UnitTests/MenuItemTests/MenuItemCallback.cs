...
using SLaks.Rebracer;

namespace Rebracer.Tests.MenuItemTests {
	[TestClass]
	public class MenuItemTest {
		...
		public void InitializeMenuCommand() {
			// Create the package
			IVsPackage package = new RebracerPackage() as IVsPackage;
			...
			CommandID menuCommandID = new CommandID(SLaks.Rebracer.GuidList.guidRebracerCmdSet, (int)SLaks.Rebracer.PkgCmdIDList.cmdCreateSolutionSettingsFile);
